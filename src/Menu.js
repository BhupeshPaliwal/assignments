...
const Demo = () => {
  ...
  return (
    <TreeSelect
      ...
      style={{ width: '200%' }}
      value={value}
      dropdownStyle={{ maxHeight: 2000, overflow: 'auto' }}
      ...
      <TreeNode value="Module 1" title="Module 1">
        <TreeNode value="Submodule 11" title="Subodule 11">
            <TreeNode value="Form Group 111" title="Form Group 111">
                  <TreeNode value="Form 1111" title={<NavLink to="/contact">Form 1111</NavLink>}/>
  ...
  render() {
    ...
    return (
      <Menu
        ...
        mode="horizontal"
      >
      <SubMenu key="SubMenu" icon={<SettingOutlined />} title="Home">
      <Demo />
      </SubMenu>
      </Menu>
